...
double MPostCal::fracdmvnorm(mat Z, mat mean, mat R, mat diagC, double NCP) {
...
double MPostCal::fracdmvnorm2(mat Z, mat mean, mat R, mat diagC, double NCP) {
...
double MPostCal::dmvnorm(mat Z, mat mean, mat R) {
        mat ZcenterMean = Z - mean;
...
//
double MPostCal::fastLikelihood(int * configure, double * stat, double NCP) {
	int causalCount = 0;
...
double MPostCal::computeTotalLikelihood(double * stat, double NCP) {
	int num = 0;
