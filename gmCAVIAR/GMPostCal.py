...
class MPostCal():
    ...
    def __init__(self, BIG_SIGMA, S_LONG_VEC, snpCount, MAX_causal, SNP_NAME, gamma, t_squared, s_squared, num_of_studies, heterability_assign):
        ...
        self.heterability_assign = heterability_assign
